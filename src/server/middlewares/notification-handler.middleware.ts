...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'stock_item.create': {
    roles: ['business-owner', 'inventory-manager'],
    key: 'new-stock-item',
    tenantPath: ['company', 'stock_item'],
    userPath: [],
  },
  'inventory.update': {
    roles: ['business-owner', 'inventory-manager'],
    key: 'stock-update',
    tenantPath: ['company', 'inventory'],
    userPath: [],
  },
  'sales_order.create': {
    roles: ['business-owner', 'sales-representative'],
    key: 'new-sales-order',
    tenantPath: ['company', 'sales_order'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'inventory-manager', 'sales-representative'];
