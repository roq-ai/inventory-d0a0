  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your business with Inventory - Your daily companion for managing stock, creating sales and purchase orders. Experience seamless inventory updates, robust reporting, and instant notifications via email and WhatsApp."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1616401784845-180882ba9ba8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbnZlbnRvcnl8ZW58MHx8fHwxNjkzNzA3MTg2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your business with Inventory - Your daily companion for managing stock, creating sales and purchase orders. Experience seamless inventory updates, robust reporting, and instant notifications via email and WhatsApp.`}
            </Text>
            <Box
