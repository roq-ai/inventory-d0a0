...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'inventory.count', 'purchase_order.count', 'sales_order.count', 'stock_item.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('inventory', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('purchase_order', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'purchase_order',
          header: 'Purchase Order',
          accessorKey: 'purchase_order',
          cell: ({ row: { original: record } }: any) => record?._count?.purchase_order,
        }
      : null,
    hasAccess('sales_order', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'sales_order',
          header: 'Sales Order',
          accessorKey: 'sales_order',
          cell: ({ row: { original: record } }: any) => record?._count?.sales_order,
        }
      : null,
    hasAccess('stock_item', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'stock_item',
          header: 'Stock Item',
          accessorKey: 'stock_item',
          cell: ({ row: { original: record } }: any) => record?._count?.stock_item,
        }
      : null,
